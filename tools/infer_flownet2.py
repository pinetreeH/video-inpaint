...
from models.FlowNet2_Models import FlowNet2
...
def parse_args():
    ...
    parser.add_argument('--frame_dir', type=str, default='./demo/lady-running/frames',
...
def infer(args):
    ...
    for i, (f1, f2, output_path_) in enumerate(dataloader_):
        ...
        task_bar.update()
    sys.stdout.write('\n')
    print('FlowNet2_Models Inference has been finished~!')
